    ...
    >
      <Dialog>
        ...
        <DialogContent>
          ...
          <form onSubmit={changePlayerOneData}>
            <Fieldset>
            ...
            <Fieldset>
              ...
              <Input id="archetype" defaultValue="" />
            </Fieldset>
            <Fieldset>
              <Label htmlFor="record">Record</Label>
              <Input id="record" defaultValue="" />
            </Fieldset>
            <Button aria-label="Close" variant="green" type="submit">
              Save changes
            </Button>
      ...
      <Dialog>
        ...
        <DialogContent>
          ...
          <Fieldset>
            ...
            <Input id="eventName" defaultValue="" />
          </Fieldset>
          <Fieldset>
            <Label htmlFor="roundInformation">Round Information</Label>
            <Input id="roundInformation" defaultValue="" />
          </Fieldset>
          <Fieldset>
            <Label htmlFor="format">Format</Label>
            <Input id="format" defaultValue="" />
          </Fieldset>
          <Flex css={{ marginTop: 25, justifyContent: "flex-end" }}>
            <DialogClose asChild>
              <Button aria-label="Close" variant="green">
